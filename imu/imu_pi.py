...
class IMU(object)
   ...
   #constructor
   def __init__(self, device_add, accel_gyro_add, mag_add)
      
      #Assign the given device address, accelerometer and gyroscope register address, and magnetometer address
      self.device_add = I2C(device_add)
